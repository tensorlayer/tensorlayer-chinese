...
..
 - Multi-layer perceptron (MNIST) classification using Iterator, see `mini-batch <https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_mlp_dropout1.py>`_ and `build two graphs <https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_mlp_dropout2.py>`_.
