...
=================
 ...
 - Distributed Training. `tutorial_mnist_distributed.py <https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_mnist_distributed.py>`_ by `https://github.com/jorgemf <https://github.com/jorgemf>`_.
